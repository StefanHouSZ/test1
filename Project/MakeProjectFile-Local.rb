...
#是否可视excel应用
excel.visible = false
workbook = excel.Workbooks.Open('F:\Jetsen_AutoTest_project\SmartJetsen\template\LocalProjectCodeModel.xlsx')
...
@tempRbStr = $data1 + "\n" + $data2 + "\n" + $data3 + "\n"
f=File.new(File.join("F:\\Jetsen_AutoTest_project\\SmartJetsen\\Project","ProjectModel-Local.rb"), "w+")   # 文件名和格式任意
f.puts(@tempRbStr)
